...
export const Route = createFileRoute("/photography")({
  head: () => ({
    meta: [
      { title: "Photography & Videography — Rafaela & Paraskevas" },
      { name: "description", content: "Full photography and videography packages for the Folegandros wedding." },
      { property: "og:title", content: "Photography & Videography — Rafaela & Paraskevas" },
      { property: "og:description", content: "Full photography and videography packages for the Folegandros wedding." },
